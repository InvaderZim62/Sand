...
class FrameNode: SCNNode {
    ...
    override init() {
        ...
        let frontPane = SCNBox(width: Constants.paneWidth,
                               height: Constants.paneHeight,
        ...
        let rearPane = SCNBox(width: Constants.paneWidth,
                              height: Constants.paneHeight,
                              length: Constants.paneThickness,
                              chamferRadius: 0)
        ...
        //----------------------------------------------------------------------
        let topCap = SCNBox(width: Constants.paneWidth + 2 * Constants.paneThickness,
        ...
        topNode.position = SCNVector3(x: 0, y: Float(Constants.paneHeight / 2 + Constants.paneThickness / 2), z: 0)
        addChildNode(topNode)

        let bottomCap = SCNBox(width: Constants.paneWidth + 2 * Constants.paneThickness,
                               height: Constants.paneThickness,
                               length: Constants.paneSeparation + Constants.paneThickness,
                               chamferRadius: 0)
        bottomCap.firstMaterial?.diffuse.contents = Constants.paneColor
        let bottomNode = SCNNode(geometry: bottomCap)
        bottomNode.position = SCNVector3(x: 0, y: -Float(Constants.paneHeight / 2 + Constants.paneThickness / 2), z: 0)
        ...
        rightNode.position = SCNVector3(x: Float(Constants.paneWidth / 2 + Constants.paneThickness / 2), y: 0, z: 0)
